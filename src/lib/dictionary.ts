...
export const ui = d({
  ...
  newLabel: { latn: "Novo", cyrl: "Ново" },
  onlyYouSee: { latn: "(vidite samo vi)", cyrl: "(видите само ви)" },
  noCityFound: { latn: "Nema grada sa tim imenom", cyrl: "Нема града са тим именом" },
  ...
  noPhotos: { latn: "Nema fotografija radova", cyrl: "Нема фотографија радова" },
  noPhotosHint: {
    latn: "Ovaj majstor još nije postavio fotografije svojih radova.",
    cyrl: "Овај мајстор још није поставио фотографије својих радова.",
  },
  noReviews: { latn: "Još nema recenzija", cyrl: "Још нема рецензија" },
  noSavedTitle: { latn: "Nemate sačuvanih majstora", cyrl: "Немате сачуваних мајстора" },
  noSavedHint: {
    latn: "Kliknite na srce pored majstora da biste ga sačuvali i lakše našli kasnije.",
    cyrl: "Кликните на срце поред мајстора да бисте га сачували и лакше нашли касније.",
  },
  browseMajstori: { latn: "Pogledajte majstore", cyrl: "Погледајте мајсторе" },
  allServices: { latn: "Sve usluge", cyrl: "Све услуге" },
  filterByService: { latn: "Filtriraj po usluzi", cyrl: "Филтрирај по услузи" },
  sortReviews: { latn: "Poređaj recenzije", cyrl: "Поређај рецензије" },
  sortNewest: { latn: "Najnovije", cyrl: "Најновије" },
  sortHighest: { latn: "Najviša ocena", cyrl: "Највиша оцена" },
  sortLowest: { latn: "Najniža ocena", cyrl: "Најнижа оцена" },
  filterByRating: { latn: "Prikaži samo ocene", cyrl: "Прикажи само оцене" },
  noMatchingReviews: {
    latn: "Nema recenzija koje odgovaraju filteru",
    cyrl: "Нема рецензија које одговарају филтеру",
  },
  noMatchingReviewsHint: {
    latn: "Promenite ocenu ili uslugu da biste videli ostale.",
    cyrl: "Промените оцену или услугу да бисте видели остале.",
  },
  showMoreReviews: { latn: "Prikaži još", cyrl: "Прикажи још" },
  ofTotal: { latn: "od", cyrl: "од" },
  noReviewsHint: {
    latn: "Budite prvi koji će oceniti rad ovog majstora.",
    cyrl: "Будите први који ће оценити рад овог мајстора.",
  },
  ...
  savedMajstor: { latn: "Sačuvan majstor", cyrl: "Сачуван мајстор" },
  ...
  haveAccount: { latn: "Već imate nalog?", cyrl: "Већ имате налог?" },
  signUpTitle: { latn: "Napravite nalog", cyrl: "Направите налог" },
  signUpGoogle: { latn: "Registracija preko Google", cyrl: "Регистрација преко Google" },
  roleQuestion: { latn: "Šta vas dovodi kod nas?", cyrl: "Шта вас доводи код нас?" },
  roleUser: { latn: "Tražim majstora", cyrl: "Тражим мајстора" },
  roleUserHint: {
    latn: "Pretražujte, čuvajte i ocenjujte majstore.",
    cyrl: "Претражујте, чувајте и оцењујте мајсторе.",
  },
  roleMajstor: { latn: "Ja sam majstor", cyrl: "Ја сам мајстор" },
  roleMajstorHint: {
    latn: "Napravite profil i dolazite do poslova.",
    cyrl: "Направите профил и долазите до послова.",
  },
  passwordHint: {
    latn: "Najmanje 8 znakova, bar jedno slovo i jedna cifra.",
    cyrl: "Најмање 8 знакова, бар једно слово и једна цифра.",
  },
  createAccount: { latn: "Napravi nalog", cyrl: "Направи налог" },
  signOut: { latn: "Odjava", cyrl: "Одјава" },
  myProfile: { latn: "Moj profil", cyrl: "Мој профил" },
